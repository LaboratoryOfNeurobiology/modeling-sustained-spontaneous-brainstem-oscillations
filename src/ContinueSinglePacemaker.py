...
def pacemaker_cell_func(LoParameters): #node):
    ...
    simulations_file = open(
        f"/media/zupanc-lab/Seagate Backup Plus Drive/2020_Pn_Oscillation/ekgkgk_pacemakercell_sims/SimulationRawOutput.txt", "a")
...
if __name__ == '__main__':
    ...
    name = fun.__name__
    file_name = '/media/zupanc-lab/Seagate Backup Plus Drive/2020_Pn_Oscillation/It_pacemaker_cell_func_2020_May_14_16h_08m'
    ...
    sol, It = IHalving_cont(pc, fun, It, dN_it, save='step', tol='same')
    print(It)
    ...
    pc.done()
    dir_path = "/media/zupanc-lab/Seagate Backup Plus Drive/2020_Pn_Oscillation/single_pacemakercell_sims"
